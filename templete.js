...
socialMedia.then(function(data) {
    ...
    // calls the rollupFunction for each AgeGroup which calculates the min,
    // q1, median, q3, and max for Likes in that group 
    const quantilesByGroups = d3.rollup(data, rollupFunction, d => d.AgeGroup);
    
    // iterate through each age group and draw the box plot elements
